...
import com.tmdt.base.presentation.dto.request.permission.CreatePermissionRequest;
import com.tmdt.base.presentation.dto.request.permission.UpdatePermissionRequest;
...
public class PermissionController {
    ...
    public ResponseEntity<SingleDataResponse<MessageDto>> create(@Valid @RequestBody CreatePermissionRequest request) {
        createUseCase.create(request.getPermissionName());
    ...
    public ResponseEntity<SingleDataResponse<MessageDto>> update(@PathVariable Long id, @Valid @RequestBody UpdatePermissionRequest request) {
        updateUseCase.updatePermission(id, request.getPermissionName());
        MessageDto  messageDto = new MessageDto("PMU002");
        return ResponseEntity.ok().body(new SingleDataResponse<>(messageDto));
    }
    ...
    public ResponseEntity<SingleDataResponse<MessageDto>> delete(
            @PathVariable Long id
    ) {
        MessageDto messageDto = new MessageDto("PMD003");
